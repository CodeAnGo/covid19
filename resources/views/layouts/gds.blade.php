...
<head>
    ...
    <!--[if !IE 8]><!-->
    <link href="{{ asset('govuk-frontend-3.6.0.min.css') }}" rel="stylesheet">
    <!--<![endif]-->
...
<div class="govuk-width-container ">
    <div class="govuk-phase-banner">
      ...
      This is a experimental service – your <a class="govuk-link" href="#">feedback</a> will help us to improve it.
    </span>
        </p>
    </div>
...
<script src="{{ asset('govuk-frontend-3.6.0.min.js') }}"></script>
<script>
